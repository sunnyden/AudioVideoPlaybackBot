...
namespace SkypeTeamsMeetingBot.AudioVideoPlaybackBot.FrontEnd.Bot
{
    using System;
    ...
    using SkypeTeamsMeetingBot.Common;
    using SkypeTeamsMeetingBot.Common.Authentication;
    using SkypeTeamsMeetingBot.Common.Logging;
    using SkypeTeamsMeetingBot.Common.Meetings;
    using SkypeTeamsMeetingBot.Common.OnlineMeetings;
        ...
        private ILocalMediaSession CreateLocalMediaSession(Guid mediaSessionId = default(Guid))
        {
            var videoSocketSettings = new List<VideoSocketSettings>
            {
                ...
                new VideoSocketSettings
                {
                    ...
                    // We loop back the video in this SkypeTeamsMeetingBot. The MediaPlatform always sends only NV12 frames.
            ...
            /*var dataSocketSettings = new DataSocketSettings
            {
                StreamDirections = StreamDirection.Sendrecv,
                ReceiveDataType = DataType.Transcript,
                SendDataType = DataType.Transcript,
